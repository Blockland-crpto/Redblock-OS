...
; ==================================================================
	...
	%DEFINE REDBLOCK_VER '1.1.5'	; OS version number
	%DEFINE REDBLOCK_API_VER 30	; API version for programs to check
...
option_screen:
	...
	os_init_msg		db 'Redblock OS', 0
	os_version_msg		db 'Version ', REDBLOCK_VER, 0

	dialog_string_1		db 'Welcome to RedBlock OS!', 0
	dialog_string_2		db 'Please select a button: OK for the', 0
	dialog_string_3		db 'menu, Cancel for command line.', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot execute RedblockOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of RedblockOS, and', 0
	kerndlg_string_3	db 'is not a RedblockOS Excuteable.', 0

	ext_string_1		db 'Invalid extension! You can', 0
	ext_string_2		db 'only execute .BIN or .BAS programs.', 0

	program_finished_msg	db '>>> Program ended --- press a key to Exit...', 0
