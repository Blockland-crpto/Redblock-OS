...
; ==================================================================
	...
	%DEFINE REDBLOCK_VER '1.1.1'	; OS version number
	%DEFINE REDBLOCK_API_VER 10	; API version for programs to check
...
option_screen:
	...
	os_init_msg		db 'Welcome to Redblock OS', 0
...
not_bas_extension:
	...
	program_finished_msg	db '>>> Program ended --- press a key to continue...', 0
